                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">Global Currency variable </span>
                                            <code class="text-center"> $app_currency </code>
                                            <span class="info-box-number text-center text-muted mb-0">{{$app_currency ." ". number_format(1255, 2)}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">Global Date format variable</span>
                                            <code class="text-center"> $app_s->date_format </code>
                                            <span class="info-box-number text-center text-muted mb-0">{{now()->format($app_s->date_format)}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">Global Time format variable</span>
                                            <code class="text-center"> $app_s->clock_format </code>
                                            <span class="info-box-number text-center text-muted mb-0">{{now()->format($app_s->clock_format)}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">Global Date and Time format variable</span>
                                            <code class="text-center"> $app_s->datetime_format </code>
                                            <span class="info-box-number text-center text-muted mb-0">{{now()->format($app_s->datetime_format)}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="post">
                                        ...
                                        <h6>Global variables about the system could be set on <i>"/system_settings"</i> url. The available variable are:</h6>
                                        <br>
                        ...
                        <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                            ...
                            <p class="text-muted"><b>Atention! </b>
                                <br>
                                This page is only a example, and the documentation is under construction. Check the updates and more details on <a href="https://github.com/gelbcke/" target="_blank">GitHub </a>
                            </p>
                            <br>
