                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            ...
                            @if(Auth::user()->image == 'profile_default.png')
                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal" action="{{route('profile.update', $user->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('theme') is-invalid @enderror" id="theme" name="theme">
                                                ...
                                                <option value="{{$theme->name}}" @if($user->theme == $theme->name) selected="selected" @endif>{{$theme->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('theme')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control @error('lockout_time') is-invalid @enderror" id="lockout_time" name="lockout_time" value="{{$user->lockout_time}}" placeholder="{{__('global.lockout_time')}}">
