        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td><b>{{__('global.name')}}:</b> {{$settings[0]->currency->name}} | <b>Code:</b> {{$settings[0]->currency->code}} | <b>Symbol:</b> {{$settings[0]->currency->symbol}}</td>
                    <td><span class="badge bg-danger">{{$app_currency ." ". number_format(1255, 2)}}</span></td>
                </tr>
                <tr>
                    <td>{{ __('system_settings.timezone') }}</td>
                    <td><b>{{ __('global.name') }}:</b> {{ $settings[0]->timezone->name }} | <b>Offset:</b> {{$settings[0]->timezone->offset}}</td>
